...
public class SearchingPage {
	...
	public static void retrieveAll(Connection conn, User user, boolean isAdmin) {
		Util.clearScr();
	...
	public static void retrieveTitle(Connection conn, String stitle, User user, boolean isAdmin) {
		Util.clearScr();
	...
	public static void retrieveFilter(Connection conn, User user, boolean isAdmin) {
		// sc.nextLine();
		String choice;
		String[] choices;
